...
<template>
  <DefineYearTemplate v-slot="{ date }">
    <div class="**:data-[slot=native-select-icon]:right-1">
      <div class="relative">
        <div
          class="
            pointer-events-none absolute inset-0 flex h-full items-center pl-2
            text-sm
          "
        >
  ...
  >
    <CalendarHeader class="pt-0">
      ...
      >
        <CalendarPrevButton class="rounded-xs">
          <slot name="calendar-prev-icon"></slot>
        </CalendarPrevButton>
        <CalendarNextButton class="rounded-xs">
      ...
      >
        ...
        <CalendarGridBody>
          ...
          >
            ...
            >
              <CalendarCellTrigger
                class="cursor-pointer rounded-xs text-sm"
                :day="weekDate"
                :month="month.value"
              />
            </CalendarCell>
